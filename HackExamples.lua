HackExamples = {
		...
		["ui: add copy/paste buttons to Color Picker"] = {
		...
		["ui: hide chat buttons, enable mouse scroll, move editbox to top"] = {
			["index"] = 20,
		...
		["|cff7cb8c7Welcome to Hack!  |cffff0000READ ME FIRST!!"] = {
			["index"] = 1,
		...
		["dev: print errors to chat frame with stack trace"] = {
			["index"] = 30,
		...
		["import: LuaSlinger pages,library,events,etc."] = {
			["index"] = 5,
		...
		["dev example: arg processing, callee"] = {
			["index"] = 35,
		...
		["ui: report who's pinging the map"] = {
			["index"] = 15,
		...
		["dev example: arg processing, caller"] = {
			["index"] = 34,
		...
		["ui: increase max camera distance/speed"] = {
			["index"] = 16,
		...
		["dev: increase chat frame height"] = {
			["index"] = 29,
